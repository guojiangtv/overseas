define('common',['layer'], function(require, exports, module){
    ...
    exports.goShare = function(){
        ...
        if(/guojiang_android/i.test(navigator.userAgent)){
            ...
            if(/iPhone.*Safari/i.test(navigator.userAgent)){
                shareBg = '<img src="http://static.cblive.tv/dist/mobile/img/common/shareBgSafari.png?v=1" id="mShareBg"/>';
            }else{
                shareBg = '<img src="http://static.cblive.tv/dist/mobile/img/common/shareBgWechat.png?v=1" id="mShareBg"/>';
            }
    ...
    */
    ...
    exports.formatDate = function(num , isSecond){
        var formatNum = new Date(parseInt(num)*1000),
            ...
            month = (parseInt(formatNum.getMonth())+ 1) < 10 ? 0+ (formatNum.getMonth() + 1).toString() : (parseInt(formatNum.getMonth())+ 1),     
    ...
    *   timegap: 1 为 每1ms倒计时，1000为1s，默认1s
     */
    var cds;
    function countDownS(time, dosomething, callback, timegap ){
        var _time = time;
